...
1. **The 6/10 PreProd PV11 hard fork and the 6/8 mainnet submission** — whether van Rossem's PreProd fork executes cleanly on 6/10 and whether the mainnet submission lands on 6/8, setting up a June mainnet enactment. SPO and tooling readiness (node v11.0.1, DB-Sync, Ogmios, Kupo) is the precondition; a clean PreProd fork is the rehearsal the mainnet go/no-go depends on.
