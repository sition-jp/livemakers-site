/**
 * ETHExtensionPanel — Ethereum spot ETF + protocol staking ratio.
 */
import { useTranslations } from "next-intl";
import type { ETHExtension } from "@/lib/terminal/asset-summary";

interface ETHExtensionPanelProps {
...
export function ETHExtensionPanel({ extension }: ETHExtensionPanelProps) {
  const t = useTranslations("assets.eth_ext");
    ...
    >
      ...
      <dl className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-md border border-border-primary bg-bg-tertiary p-4">
          ...
          <dd className="text-2xl font-light tracking-title text-pillar-ecosystem">
            {extension.staking_ratio_pct.toFixed(2)}%
          </dd>
        </div>
      </dl>
    </section>
