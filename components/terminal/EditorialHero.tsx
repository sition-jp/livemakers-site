...
export function EditorialHero({ brief, locale }: { brief: Brief; locale: string }) {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 pt-10 pb-12">
      ...
      <h1 className="mb-5 max-w-4xl text-4xl font-light leading-tight tracking-title md:text-5xl md:leading-[1.2]">
        {title}
      </h1>
      <p className="mb-6 max-w-3xl text-lg leading-relaxed text-text-secondary">
        {summary}
      </p>
